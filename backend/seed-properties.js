...
const dummyProperties = [
  ...
  },
  {
    ...
    description: 'Modern 3BHK apartment in the heart of Baner, Pune. Close to IT hub and premium shopping.',
    price: 8500000,
    type: 'sale',
    property_type: 'apartment',
    bedrooms: 3,
    ...
    area: 1650,
    location: 'Baner, Pune',
    address: 'Near Balewadi High Street, Pune',
    latitude: 18.5590,
    longitude: 73.7791,
    features: JSON.stringify(['Gym', 'Swimming Pool', 'Security', 'Parking', 'Clubhouse']),
    images: JSON.stringify([
      'https://images.unsplash.com/photo-1545324418-cc1a9d6faf4f?w=500',
    ]),
    developer_name: 'Pune Realty',
    developer_phone: '9876543210',
    developer_whatsapp: '9876543210',
    is_featured: 1,
  },
  {
    title: 'Modern Flat in Koregaon Park',
    description: 'Elegant 2BHK flat in the most premium locality of Pune. Surrounded by greenery and cafes.',
    price: 12000000,
    type: 'sale',
    property_type: 'apartment',
    bedrooms: 2,
    ...
    latitude: 18.5362,
    longitude: 73.8940,
    features: JSON.stringify(['Security', 'Parking', 'Balcony', 'Garden']),
    images: JSON.stringify([
      'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=500',
    ]),
    developer_name: 'Elite Builders',
    developer_phone: '9876543211',
    developer_whatsapp: '9876543211',
    is_featured: 1,
  },
];
