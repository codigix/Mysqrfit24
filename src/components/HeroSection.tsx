  ...
  return (
    <section className="relative min-h-[650px] flex items-center justify-center overflow-hidden rounded-b-3xl">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 py-20 text-center">
        {/* Main Heading */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold text-white mb-12 leading-tight">
          The Finest Napa's
          <br />
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-8 text-white">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm sm:text-base font-medium">7,000+ SOLD HOMES</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-xl">•</span>
            <span className="text-sm sm:text-base font-medium">1 BILLION $ IN SALES</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-xl">•</span>
            <span className="text-sm sm:text-base font-medium">1,000+ SATISFIED CUSTOMERS</span>
          </div>
        </div>
      </div>
    </section>
