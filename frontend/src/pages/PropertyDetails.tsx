...
const mockPropertyData: Record<string, Property> = {
  'mock-1': {
    id: 'mock-1',
    title: "Luxury Sky Apartment",
    description: "Experience the pinnacle of urban living in this stunning sky apartment. Featuring floor-to-ceiling windows with panoramic city views, high-end finishes, and state-of-the-art appliances. This residence offers an unparalleled lifestyle in the heart of the city.",
    price: 4500000,
    type: 'sale',
    ...
    features: ['Gym', 'Swimming Pool', 'Security', 'CCTV', 'Power Backup', 'Lift Service'],
    city: "Pune",
    propertyId: "P-1001",
    yearBuilt: 2023,
    reviews: [
      { id: 1, author: "John Doe", rating: 5, comment: "Amazing view and top notch amenities!", date: "2023-10-15" }
    ]
  },
  'mock-2': {
    id: 'mock-2',
    title: "Modern Studio Flat",
    description: "A chic and modern studio flat perfect for young professionals. Compact yet functional design with efficient use of space. Located close to major tech hubs and vibrant nightlife.",
    price: 15000,
    type: 'rent',
    property_type: 'flats',
    bedrooms: 1,
    ...
    features: ['WiFi', 'Security', 'Intercom', 'Water Supply'],
    city: "Pune",
    propertyId: "P-1002",
    yearBuilt: 2021
  },
  'mock-3': {
    ...
    description: "Large industrial godown suitable for storage and logistics. Features high ceilings, heavy-duty flooring, and excellent connectivity to major highways. Ideal for distribution centers.",
    price: 50000,
    type: 'lease',
    ...
    features: ['Security', 'Parking Spaces', 'Water Supply', 'Electricity'],
    city: "Pune",
    propertyId: "P-1003",
    yearBuilt: 2019
  },
  'mock-4': {
    ...
    description: "Highly visible retail space in a bustling commercial district. Excellent frontage, high foot traffic, and modern shop infrastructure. Perfect for premium brands.",
    price: 8500000,
    type: 'sale',
    property_type: 'shops',
    area: 800,
    ...
    features: ['Air Conditioning', 'CCTV', 'Security', 'Power Backup'],
    city: "Pune",
    propertyId: "P-1004",
    yearBuilt: 2022
  },
  'mock-5': {
    ...
    description: "Beautifully designed row house offering privacy and comfort. Features a private garden, spacious balconies, and premium interior fittings. Located in a quiet residential neighborhood.",
    price: 12000000,
    type: 'sale',
    ...
    features: ['Garden', 'Balcony', 'Terrace', 'Gated Community', 'Security'],
    city: "Pune",
    propertyId: "P-1005",
    yearBuilt: 2020
  },
  'mock-6': {
    ...
    description: "Affordable 2BHK apartment in an upcoming residential area. Well-maintained building with basic amenities. Close to schools and markets.",
    price: 12000,
    type: 'rent',
    property_type: 'apartment',
    bedrooms: 2,
    ...
    features: ['Lift', 'Security', 'Water Supply', 'Parking'],
    city: "Pune",
    propertyId: "P-1006",
    yearBuilt: 2015
  },
  'mock-7': {
    ...
    description: "Strategically located open land available for lease. Level ground with clear boundaries. Suitable for temporary storage or development projects.",
    price: 25000,
    type: 'lease',
    ...
    features: ['Fencing', 'Road Access', 'Water Connection'],
    city: "Pune",
    propertyId: "P-1007"
  },
  'mock-8': {
    ...
    description: "Ultra-luxurious penthouse with a massive private terrace. Features bespoke interiors, a private pool, and 360-degree views. The ultimate statement of luxury.",
    price: 25000000,
    type: 'sale',
    property_type: 'apartment',
    bedrooms: 5,
    ...
    features: ['Swimming Pool', 'Private Terrace', 'Gym', 'Club House', '24/7 Security'],
    city: "Pune",
    propertyId: "P-1008",
    yearBuilt: 2024
  },
  'mock-9': {
    ...
    description: "Conveniently located flat near major universities. Fully furnished options available. Safe and secure environment with high-speed internet.",
    price: 8000,
    type: 'rent',
    property_type: 'flats',
    bedrooms: 1,
  ...
  'mock-10': {
    ...
    description: "Massive industrial facility designed for heavy manufacturing or large-scale storage. Features multiple loading bays and robust utility connections.",
    price: 150000,
    type: 'lease',
    property_type: 'godowns',
    area: 15000,
    ...
    features: ['Electricity', 'Power Backup', 'Fire Safety', 'Loading Docks'],
    city: "Pune",
    propertyId: "P-1010",
    yearBuilt: 2012
  },
  'mock-11': {
    ...
    description: "Contemporary row house with a sleek architectural design. Features open-plan living, modern kitchen, and energy-efficient systems.",
    price: 9500000,
    type: 'sale',
    property_type: 'rowhouses',
    bedrooms: 3,
    ...
    features: ['Solar Power', 'Parking', 'Garden', 'Balcony'],
    city: "Pune",
    propertyId: "P-1011",
    yearBuilt: 2022
  },
  'mock-12': {
    ...
    description: "Charming shop space in a high-end boutique mall. Elegant interiors and excellent visibility. Ideal for fashion or lifestyle brands.",
    price: 35000,
    type: 'rent',
    property_type: 'shops',
    area: 400,
    ...
    features: ['CCTV', 'Security', 'Air Conditioning', 'WiFi'],
    city: "Pune",
    propertyId: "P-1012",
    yearBuilt: 2021
  },
  'mock-13': {
    ...
    description: "Peaceful 2BHK apartment overlooking a lush green park. Well-ventilated rooms with plenty of natural light. Family-friendly community.",
    price: 18000,
    type: 'rent',
    property_type: 'apartment',
    bedrooms: 2,
    ...
    features: ['Garden', 'Kids Play Area', 'Security', 'Water Supply'],
    city: "Pune",
    propertyId: "P-1013",
    yearBuilt: 2017
  },
  'mock-14': {
    ...
    description: "Huge industrial plot in a prime manufacturing zone. Ready for construction with all necessary approvals. Excellent connectivity to port and airport.",
    price: 50000000,
    type: 'sale',
    property_type: 'openland',
    area: 20000,
    ...
    features: ['Electricity', 'Water', 'Road Access', 'Industrial Approval'],
    city: "Pune",
    propertyId: "P-1014"
  },
  'mock-15': {
    ...
    description: "Classic suburban row house with a cozy feel. Perfect for a growing family. Safe neighborhood with parks and community centers nearby.",
    price: 8000000,
    type: 'sale',
    property_type: 'rowhouses',
    bedrooms: 3,
    ...
    features: ['Parking', 'Community Center', 'Security', 'Water Supply'],
    city: "Pune",
    propertyId: "P-1015",
    yearBuilt: 2010
  },
  'mock-16': {
    ...
    description: "Premium high street shop with massive footfall. Large display windows and modern lighting. Perfect for flagship stores.",
    price: 75000,
    type: 'lease',
    property_type: 'shops',
    area: 1200,
    ...
    features: ['Power Backup', 'CCTV', 'Security', 'WiFi'],
    city: "Pune",
    propertyId: "P-1016",
    yearBuilt: 2023
  },
  'mock-17': {
    ...
    description: "Well-designed studio apartment offering comfort and style. Fully equipped kitchenette and modern bathroom. Great investment opportunity.",
    price: 5500000,
    type: 'sale',
    property_type: 'apartment',
    bedrooms: 1,
    ...
    features: ['Lift', 'Gym', 'Security', 'Power Backup'],
    city: "Pune",
    propertyId: "P-1017",
    yearBuilt: 2021
  },
  'mock-18': {
    ...
    description: "Spacious and elegant flat designed for executives. Features premium finishes, large bedrooms, and a dedicated workspace. Located in a prime business district.",
    price: 25000,
    type: 'rent',
    property_type: 'flats',
    bedrooms: 2,
    ...
    features: ['Parking', 'Gym', 'WiFi', 'Intercom', 'Security'],
    city: "Pune",
    propertyId: "P-1018",
    yearBuilt: 2019
  },
  'mock-19': {
    ...
    description: "Ready-to-use distribution center with cold storage facilities. Excellent logistics infrastructure and easy access to major transportation nodes.",
    price: 200000,
    type: 'lease',
    property_type: 'godowns',
    area: 25000,
    ...
    features: ['Cold Storage', 'Electricity', 'Security', 'Loading Docks'],
    city: "Pune",
    propertyId: "P-1019",
    yearBuilt: 2022
  },
  'mock-20': {
    ...
    description: "Stunning row house with a refreshing coastal design theme. Features large windows, breezy balconies, and high-quality materials. A perfect retreat from the city.",
    price: 15000000,
    type: 'sale',
    property_type: 'rowhouses',
    bedrooms: 4,
    ...
    features: ['Terrace', 'Balcony', 'Garden', 'Security', 'Water Supply'],
    city: "Pune",
    propertyId: "P-1020",
    yearBuilt: 2023
  }
